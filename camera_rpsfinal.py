...
class RPS:
    ...
    def easy_mode(self):
        ...
        computer_choice_easy = RPS.get_computer_choice(self)
        user_choice_easy = RPS.get_prediction(self)
        RPS.get_winner(self, user_choice_easy, computer_choice_easy)
        RPS.first_to_three(self)
    ...
    def hard_mode(self):
        ...
        user_choice_hard = RPS.get_prediction(self)

        if user_choice_hard == "Rock":
            computer_choice_hard = "Paper"
            

        elif user_choice_hard == "Paper":
            computer_choice_hard = "Scissors"
            

        elif user_choice_hard == "Scissors":
            computer_choice_hard = "Rock"

                  

        RPS.get_winner(self, user_choice_hard, computer_choice_hard)
        RPS.first_to_three(self)
